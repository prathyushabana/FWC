.include "/home/student/Desktop/assignment1_assembly/codes/m328Pdef.inc"
...
ldi r25,0b00000001      ;initializing p(clk)
...
out PORTD,r25		;writing output to pin 5
