...
\ifthenelse{\isundefined{\gnumericColB}}{\newlength{\gnumericColB}}{}\settowidth{\gnumericColB}{\begin{tabular}{@{}p{57pt*\gnumericScale}@{}}x\end{tabular}}
...
\hhline{|-|-|-|}
	...
	{\gnumericPB{\centering}\textbf{Inputs}}
...
\hhline{|---|}
	...
	&\multicolumn{1}{p{\gnumericColC}|}%
	{\gnumericPB{\centering}{Sum of intercepts}}
\\
\hhline{|---|}
	 \multicolumn{1}{|p{\gnumericColA}|}%
	{\gnumericPB{\centering}{ab}}
	&\multicolumn{1}{p{\gnumericColB}|}%
	{\gnumericPB{\centering}{-6}}
	&\multicolumn{1}{p{\gnumericColC}|}%
	{\gnumericPB{\centering}{Product of intercepts}}
\\
\hhline{|-|-|-|}
\end{tabular}
